...
class ChatMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chat_message" do
    assert_difference('ChatMessage.count') do
      post chat_messages_url, params: { chat_message: { message: @chat_message.message, recipient_id: @chat_message.recipient_id, sender_id: @chat_message.sender_id } }
    end
  ...
  test "should update chat_message" do
    patch chat_message_url(@chat_message), params: { chat_message: { message: @chat_message.message, recipient_id: @chat_message.recipient_id, sender_id: @chat_message.sender_id } }
